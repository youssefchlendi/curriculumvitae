...
\resumeSubheading{Capgemini}{À distance}
    ...
    \resumeItemListStart
        \resumeItem{Développement de Solution de Débogage d'Appareils}
          {Développement d'une nouvelle solution complète pour Electrolux intégrant des capacités de débogage d'appareils électroménagers utilisant des protocoles de communication de bas niveau. La solution permet le diagnostic à distance et le dépannage d'appareils électroménagers via une intégration de protocoles avancés.}
        \resumeItem{Intégration Cloud Azure}
          {Implémentation et intégration de diverses solutions Azure incluant Azure Active Directory pour la gestion d'identité, Azure Web Services pour l'hébergement d'applications évolutives, et les files d'attente Azure Service Bus pour une communication inter-services fiable.}
        \resumeItem{Implémentation de Protocoles de Bas Niveau}
          {Conception et implémentation de couches de communication utilisant des protocoles de bas niveau pour établir des connexions fiables avec le matériel d'appareils pour la surveillance en temps réel et la collecte de données de diagnostic.}
        \resumeItem{Conception d'Architecture d'Entreprise}
          {Contribution à la conception architecturale de solutions de niveau entreprise qui gèrent le traitement de données d'appareils à haut volume et fournissent des expériences utilisateur fluides pour les équipes de support technique.}
    \resumeItemListEnd
        {Technologies : .NET Core, Vue.js, Azure AD, Azure Web Services, Azure Service Bus, Protocoles de bas niveau, Architecture d'entreprise, Intégration d'appareils}
